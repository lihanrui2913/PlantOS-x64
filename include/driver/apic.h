...
void apic_ioapic_level_ack(uint64_t irq_num); // ioapic电平触发 应答
void apic_ioapic_edge_ack(uint64_t irq_num);  // ioapic边沿触发 应答

// void apic_local_apic_level_ack(uint64_t irq_num);// local apic电平触发 应答
void apic_local_apic_edge_ack(uint64_t irq_num); // local apic边沿触发 应答
